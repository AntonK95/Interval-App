...
//   useEffect(() => {
//     // Dela upp timeValues till sekunder och minuter
//     const [ seconds, minutes ] = timeValues.split(':').map(Number);

//     // Visarna skall rotera i steg om 6grader. 360 / 60 = 6
//     const secondsRotationDeg = seconds * -6; 
//     setSecondsRotation(secondsRotationDeg);

//     const minutesRotationDeg = minutes * 6 + (seconds / 60 ) * 6;
